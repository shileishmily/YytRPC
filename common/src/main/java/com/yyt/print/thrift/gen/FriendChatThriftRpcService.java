package com.yyt.print.thrift.gen; /**
...
public class FriendChatThriftRpcService {
  ...
  public interface AsyncIface {
    ...
    public void saveFriend(int userId, int friendId, AsyncMethodCallback resultHandler) throws TException;

    public void deleteFriend(int userId, int friendId, AsyncMethodCallback resultHandler) throws TException;

    public void getFriend(int userId, int friendId, AsyncMethodCallback resultHandler) throws TException;

    public void queryMyFriend(int userId, AsyncMethodCallback resultHandler) throws TException;

    public void saveFriendApply(String friendApply, AsyncMethodCallback resultHandler) throws TException;

    public void queryFriendApply(int userId, AsyncMethodCallback resultHandler) throws TException;

    public void agreeFriendApply(int applyId, int userId, int friendId, AsyncMethodCallback resultHandler) throws TException;

    public void refuseFriendApply(int applyId, int userId, int friendId, AsyncMethodCallback resultHandler) throws TException;

    public void saveChatSession(String chatSession, AsyncMethodCallback resultHandler) throws TException;

    public void queryChatSessionList(int userId, int position, int size, AsyncMethodCallback resultHandler) throws TException;

    public void queryChartRecordList(int sessionId, int position, int size, AsyncMethodCallback resultHandler) throws TException;

    public void sendMsg(int userId, int msgId, String msgContent, int type, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_saveFriend(int userId, int friendId) throws TException
    {
    ...
    public int recv_saveFriend() throws TException
    {
    ...
    public void send_deleteFriend(int userId, int friendId) throws TException
    {
    ...
    public int recv_deleteFriend() throws TException
    {
    ...
    public void send_getFriend(int userId, int friendId) throws TException
    {
    ...
    public String recv_getFriend() throws TException
    {
    ...
    public void send_queryMyFriend(int userId) throws TException
    {
    ...
    public String recv_queryMyFriend() throws TException
    {
    ...
    public void send_saveFriendApply(String friendApply) throws TException
    {
    ...
    public int recv_saveFriendApply() throws TException
    {
    ...
    public void send_queryFriendApply(int userId) throws TException
    {
    ...
    public String recv_queryFriendApply() throws TException
    {
    ...
    public void send_agreeFriendApply(int applyId, int userId, int friendId) throws TException
    {
    ...
    public int recv_agreeFriendApply() throws TException
    {
    ...
    public void send_refuseFriendApply(int applyId, int userId, int friendId) throws TException
    {
    ...
    public int recv_refuseFriendApply() throws TException
    {
    ...
    public void send_saveChatSession(String chatSession) throws TException
    {
    ...
    public int recv_saveChatSession() throws TException
    {
    ...
    public void send_queryChatSessionList(int userId, int position, int size) throws TException
    {
    ...
    public String recv_queryChatSessionList() throws TException
    {
    ...
    public void send_queryChartRecordList(int sessionId, int position, int size) throws TException
    {
    ...
    public String recv_queryChartRecordList() throws TException
    {
    ...
    public void send_sendMsg(int userId, int msgId, String msgContent, int type) throws TException
    {
    ...
    public int recv_sendMsg() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class saveFriend_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public saveFriend_call(int userId, int friendId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
    ...
    public static class deleteFriend_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      private int friendId;
      public deleteFriend_call(int userId, int friendId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.friendId = friendId;
      }
    ...
    public static class getFriend_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      private int friendId;
      public getFriend_call(int userId, int friendId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.friendId = friendId;
      }
    ...
    public static class queryMyFriend_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      public queryMyFriend_call(int userId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
      }
    ...
    public static class saveFriendApply_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public saveFriendApply_call(String friendApply, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class queryFriendApply_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int userId;
      public queryFriendApply_call(int userId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
      }
    ...
    public static class agreeFriendApply_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int userId;
      private int friendId;
      public agreeFriendApply_call(int applyId, int userId, int friendId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class refuseFriendApply_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int userId;
      private int friendId;
      public refuseFriendApply_call(int applyId, int userId, int friendId, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.applyId = applyId;
        this.userId = userId;
        this.friendId = friendId;
    ...
    public static class saveChatSession_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public saveChatSession_call(String chatSession, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class queryChatSessionList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int size;
      public queryChatSessionList_call(int userId, int position, int size, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
    ...
    public static class queryChartRecordList_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int position;
      private int size;
      public queryChartRecordList_call(int sessionId, int position, int size, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
    ...
    public static class sendMsg_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private int type;
      public sendMsg_call(int userId, int msgId, String msgContent, int type, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.userId = userId;
        this.msgId = msgId;
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class saveFriend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, saveFriend_args> {
      ...
      public saveFriend_result getResult(I iface, saveFriend_args args) throws TException {
        saveFriend_result result = new saveFriend_result();
    ...
    public static class deleteFriend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, deleteFriend_args> {
      ...
      public deleteFriend_result getResult(I iface, deleteFriend_args args) throws TException {
        deleteFriend_result result = new deleteFriend_result();
    ...
    public static class getFriend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getFriend_args> {
      ...
      public getFriend_result getResult(I iface, getFriend_args args) throws TException {
        getFriend_result result = new getFriend_result();
    ...
    public static class queryMyFriend<I extends Iface> extends org.apache.thrift.ProcessFunction<I, queryMyFriend_args> {
      ...
      public queryMyFriend_result getResult(I iface, queryMyFriend_args args) throws TException {
        queryMyFriend_result result = new queryMyFriend_result();
    ...
    public static class saveFriendApply<I extends Iface> extends org.apache.thrift.ProcessFunction<I, saveFriendApply_args> {
      ...
      public saveFriendApply_result getResult(I iface, saveFriendApply_args args) throws TException {
        saveFriendApply_result result = new saveFriendApply_result();
    ...
    public static class queryFriendApply<I extends Iface> extends org.apache.thrift.ProcessFunction<I, queryFriendApply_args> {
      ...
      public queryFriendApply_result getResult(I iface, queryFriendApply_args args) throws TException {
        queryFriendApply_result result = new queryFriendApply_result();
    ...
    public static class agreeFriendApply<I extends Iface> extends org.apache.thrift.ProcessFunction<I, agreeFriendApply_args> {
      ...
      public agreeFriendApply_result getResult(I iface, agreeFriendApply_args args) throws TException {
        agreeFriendApply_result result = new agreeFriendApply_result();
    ...
    public static class refuseFriendApply<I extends Iface> extends org.apache.thrift.ProcessFunction<I, refuseFriendApply_args> {
      ...
      public refuseFriendApply_result getResult(I iface, refuseFriendApply_args args) throws TException {
        refuseFriendApply_result result = new refuseFriendApply_result();
    ...
    public static class saveChatSession<I extends Iface> extends org.apache.thrift.ProcessFunction<I, saveChatSession_args> {
      ...
      public saveChatSession_result getResult(I iface, saveChatSession_args args) throws TException {
        saveChatSession_result result = new saveChatSession_result();
    ...
    public static class queryChatSessionList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, queryChatSessionList_args> {
      ...
      public queryChatSessionList_result getResult(I iface, queryChatSessionList_args args) throws TException {
        queryChatSessionList_result result = new queryChatSessionList_result();
    ...
    public static class queryChartRecordList<I extends Iface> extends org.apache.thrift.ProcessFunction<I, queryChartRecordList_args> {
      ...
      public queryChartRecordList_result getResult(I iface, queryChartRecordList_args args) throws TException {
        queryChartRecordList_result result = new queryChartRecordList_result();
    ...
    public static class sendMsg<I extends Iface> extends org.apache.thrift.ProcessFunction<I, sendMsg_args> {
      ...
      public sendMsg_result getResult(I iface, sendMsg_args args) throws TException {
        sendMsg_result result = new sendMsg_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class saveFriend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, saveFriend_args, Integer> {
      ...
      public void start(I iface, saveFriend_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class deleteFriend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deleteFriend_args, Integer> {
      ...
      public void start(I iface, deleteFriend_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class getFriend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getFriend_args, String> {
      ...
      public void start(I iface, getFriend_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class queryMyFriend<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, queryMyFriend_args, String> {
      ...
      public void start(I iface, queryMyFriend_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class saveFriendApply<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, saveFriendApply_args, Integer> {
      ...
      public void start(I iface, saveFriendApply_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class queryFriendApply<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, queryFriendApply_args, String> {
      ...
      public void start(I iface, queryFriendApply_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class agreeFriendApply<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, agreeFriendApply_args, Integer> {
      ...
      public void start(I iface, agreeFriendApply_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class refuseFriendApply<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, refuseFriendApply_args, Integer> {
      ...
      public void start(I iface, refuseFriendApply_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class saveChatSession<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, saveChatSession_args, Integer> {
      ...
      public void start(I iface, saveChatSession_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class queryChatSessionList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, queryChatSessionList_args, String> {
      ...
      public void start(I iface, queryChatSessionList_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class queryChartRecordList<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, queryChartRecordList_args, String> {
      ...
      public void start(I iface, queryChartRecordList_args args, AsyncMethodCallback<String> resultHandler) throws TException {
    ...
    public static class sendMsg<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sendMsg_args, Integer> {
      ...
      public void start(I iface, sendMsg_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
  ...
  public static class saveFriend_args implements org.apache.thrift.TBase<saveFriend_args, saveFriend_args._Fields>, java.io.Serializable, Cloneable, Comparable<saveFriend_args>   {
    ...
    private static class saveFriend_argsStandardScheme extends StandardScheme<saveFriend_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveFriend_args struct) throws TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveFriend_args struct) throws TException {
        struct.validate();
    ...
    private static class saveFriend_argsTupleScheme extends TupleScheme<saveFriend_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveFriend_args struct) throws TException {
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveFriend_args struct) throws TException {
  ...
  public static class saveFriend_result implements org.apache.thrift.TBase<saveFriend_result, saveFriend_result._Fields>, java.io.Serializable, Cloneable, Comparable<saveFriend_result>   {
    ...
    private static class saveFriend_resultStandardScheme extends StandardScheme<saveFriend_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveFriend_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveFriend_result struct) throws TException {
        struct.validate();
    ...
    private static class saveFriend_resultTupleScheme extends TupleScheme<saveFriend_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveFriend_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveFriend_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
  ...
  public static class deleteFriend_args implements org.apache.thrift.TBase<deleteFriend_args, deleteFriend_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteFriend_args>   {
    ...
    private static class deleteFriend_argsStandardScheme extends StandardScheme<deleteFriend_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, deleteFriend_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, deleteFriend_args struct) throws TException {
        struct.validate();
    ...
    private static class deleteFriend_argsTupleScheme extends TupleScheme<deleteFriend_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, deleteFriend_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, deleteFriend_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.userId = iprot.readI32();
  ...
  public static class deleteFriend_result implements org.apache.thrift.TBase<deleteFriend_result, deleteFriend_result._Fields>, java.io.Serializable, Cloneable, Comparable<deleteFriend_result>   {
    ...
    private static class deleteFriend_resultStandardScheme extends StandardScheme<deleteFriend_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, deleteFriend_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, deleteFriend_result struct) throws TException {
        struct.validate();
    ...
    private static class deleteFriend_resultTupleScheme extends TupleScheme<deleteFriend_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, deleteFriend_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, deleteFriend_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
  ...
  public static class getFriend_args implements org.apache.thrift.TBase<getFriend_args, getFriend_args._Fields>, java.io.Serializable, Cloneable, Comparable<getFriend_args>   {
    ...
    private static class getFriend_argsStandardScheme extends StandardScheme<getFriend_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getFriend_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFriend_args struct) throws TException {
        struct.validate();
    ...
    private static class getFriend_argsTupleScheme extends TupleScheme<getFriend_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getFriend_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getFriend_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(2);
        if (incoming.get(0)) {
          struct.userId = iprot.readI32();
  ...
  public static class getFriend_result implements org.apache.thrift.TBase<getFriend_result, getFriend_result._Fields>, java.io.Serializable, Cloneable, Comparable<getFriend_result>   {
    ...
    private static class getFriend_resultStandardScheme extends StandardScheme<getFriend_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, getFriend_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getFriend_result struct) throws TException {
        struct.validate();
    ...
    private static class getFriend_resultTupleScheme extends TupleScheme<getFriend_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getFriend_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getFriend_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class queryMyFriend_args implements org.apache.thrift.TBase<queryMyFriend_args, queryMyFriend_args._Fields>, java.io.Serializable, Cloneable, Comparable<queryMyFriend_args>   {
    ...
    private static class queryMyFriend_argsStandardScheme extends StandardScheme<queryMyFriend_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryMyFriend_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryMyFriend_args struct) throws TException {
        struct.validate();
    ...
    private static class queryMyFriend_argsTupleScheme extends TupleScheme<queryMyFriend_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryMyFriend_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryMyFriend_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.userId = iprot.readI32();
  ...
  public static class queryMyFriend_result implements org.apache.thrift.TBase<queryMyFriend_result, queryMyFriend_result._Fields>, java.io.Serializable, Cloneable, Comparable<queryMyFriend_result>   {
    ...
    private static class queryMyFriend_resultStandardScheme extends StandardScheme<queryMyFriend_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryMyFriend_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryMyFriend_result struct) throws TException {
        struct.validate();
    ...
    private static class queryMyFriend_resultTupleScheme extends TupleScheme<queryMyFriend_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryMyFriend_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryMyFriend_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class saveFriendApply_args implements org.apache.thrift.TBase<saveFriendApply_args, saveFriendApply_args._Fields>, java.io.Serializable, Cloneable, Comparable<saveFriendApply_args>   {
    ...
    private static class saveFriendApply_argsStandardScheme extends StandardScheme<saveFriendApply_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveFriendApply_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveFriendApply_args struct) throws TException {
        struct.validate();
    ...
    private static class saveFriendApply_argsTupleScheme extends TupleScheme<saveFriendApply_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveFriendApply_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveFriendApply_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.friendApply = iprot.readString();
  ...
  public static class saveFriendApply_result implements org.apache.thrift.TBase<saveFriendApply_result, saveFriendApply_result._Fields>, java.io.Serializable, Cloneable, Comparable<saveFriendApply_result>   {
    ...
    private static class saveFriendApply_resultStandardScheme extends StandardScheme<saveFriendApply_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveFriendApply_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveFriendApply_result struct) throws TException {
        struct.validate();
    ...
    private static class saveFriendApply_resultTupleScheme extends TupleScheme<saveFriendApply_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveFriendApply_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveFriendApply_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
  ...
  public static class queryFriendApply_args implements org.apache.thrift.TBase<queryFriendApply_args, queryFriendApply_args._Fields>, java.io.Serializable, Cloneable, Comparable<queryFriendApply_args>   {
    ...
    private static class queryFriendApply_argsStandardScheme extends StandardScheme<queryFriendApply_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryFriendApply_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryFriendApply_args struct) throws TException {
        struct.validate();
    ...
    private static class queryFriendApply_argsTupleScheme extends TupleScheme<queryFriendApply_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryFriendApply_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryFriendApply_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.userId = iprot.readI32();
  ...
  public static class queryFriendApply_result implements org.apache.thrift.TBase<queryFriendApply_result, queryFriendApply_result._Fields>, java.io.Serializable, Cloneable, Comparable<queryFriendApply_result>   {
    ...
    private static class queryFriendApply_resultStandardScheme extends StandardScheme<queryFriendApply_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryFriendApply_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryFriendApply_result struct) throws TException {
        struct.validate();
    ...
    private static class queryFriendApply_resultTupleScheme extends TupleScheme<queryFriendApply_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryFriendApply_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryFriendApply_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class agreeFriendApply_args implements org.apache.thrift.TBase<agreeFriendApply_args, agreeFriendApply_args._Fields>, java.io.Serializable, Cloneable, Comparable<agreeFriendApply_args>   {
    ...
    private static class agreeFriendApply_argsStandardScheme extends StandardScheme<agreeFriendApply_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, agreeFriendApply_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, agreeFriendApply_args struct) throws TException {
        struct.validate();
    ...
    private static class agreeFriendApply_argsTupleScheme extends TupleScheme<agreeFriendApply_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, agreeFriendApply_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, agreeFriendApply_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
  ...
  public static class agreeFriendApply_result implements org.apache.thrift.TBase<agreeFriendApply_result, agreeFriendApply_result._Fields>, java.io.Serializable, Cloneable, Comparable<agreeFriendApply_result>   {
    ...
    private static class agreeFriendApply_resultStandardScheme extends StandardScheme<agreeFriendApply_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, agreeFriendApply_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, agreeFriendApply_result struct) throws TException {
        struct.validate();
    ...
    private static class agreeFriendApply_resultTupleScheme extends TupleScheme<agreeFriendApply_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, agreeFriendApply_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, agreeFriendApply_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
  ...
  public static class refuseFriendApply_args implements org.apache.thrift.TBase<refuseFriendApply_args, refuseFriendApply_args._Fields>, java.io.Serializable, Cloneable, Comparable<refuseFriendApply_args>   {
    ...
    private static class refuseFriendApply_argsStandardScheme extends StandardScheme<refuseFriendApply_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, refuseFriendApply_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, refuseFriendApply_args struct) throws TException {
        struct.validate();
    ...
    private static class refuseFriendApply_argsTupleScheme extends TupleScheme<refuseFriendApply_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, refuseFriendApply_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetApplyId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, refuseFriendApply_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(3);
        if (incoming.get(0)) {
          struct.applyId = iprot.readI32();
  ...
  public static class refuseFriendApply_result implements org.apache.thrift.TBase<refuseFriendApply_result, refuseFriendApply_result._Fields>, java.io.Serializable, Cloneable, Comparable<refuseFriendApply_result>   {
    ...
    private static class refuseFriendApply_resultStandardScheme extends StandardScheme<refuseFriendApply_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, refuseFriendApply_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, refuseFriendApply_result struct) throws TException {
        struct.validate();
    ...
    private static class refuseFriendApply_resultTupleScheme extends TupleScheme<refuseFriendApply_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, refuseFriendApply_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, refuseFriendApply_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
  ...
  public static class saveChatSession_args implements org.apache.thrift.TBase<saveChatSession_args, saveChatSession_args._Fields>, java.io.Serializable, Cloneable, Comparable<saveChatSession_args>   {
    ...
    private static class saveChatSession_argsStandardScheme extends StandardScheme<saveChatSession_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveChatSession_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveChatSession_args struct) throws TException {
        struct.validate();
    ...
    private static class saveChatSession_argsTupleScheme extends TupleScheme<saveChatSession_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveChatSession_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveChatSession_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.chatSession = iprot.readString();
  ...
  public static class saveChatSession_result implements org.apache.thrift.TBase<saveChatSession_result, saveChatSession_result._Fields>, java.io.Serializable, Cloneable, Comparable<saveChatSession_result>   {
    ...
    private static class saveChatSession_resultStandardScheme extends StandardScheme<saveChatSession_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, saveChatSession_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, saveChatSession_result struct) throws TException {
        struct.validate();
    ...
    private static class saveChatSession_resultTupleScheme extends TupleScheme<saveChatSession_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, saveChatSession_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, saveChatSession_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
  ...
  public static class queryChatSessionList_args implements org.apache.thrift.TBase<queryChatSessionList_args, queryChatSessionList_args._Fields>, java.io.Serializable, Cloneable, Comparable<queryChatSessionList_args>   {
    ...
    private static class queryChatSessionList_argsStandardScheme extends StandardScheme<queryChatSessionList_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryChatSessionList_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryChatSessionList_args struct) throws TException {
        struct.validate();
    ...
    private static class queryChatSessionList_argsTupleScheme extends TupleScheme<queryChatSessionList_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryChatSessionList_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryChatSessionList_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(3);
        if (incoming.get(0)) {
          struct.userId = iprot.readI32();
  ...
  public static class queryChatSessionList_result implements org.apache.thrift.TBase<queryChatSessionList_result, queryChatSessionList_result._Fields>, java.io.Serializable, Cloneable, Comparable<queryChatSessionList_result>   {
    ...
    private static class queryChatSessionList_resultStandardScheme extends StandardScheme<queryChatSessionList_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryChatSessionList_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryChatSessionList_result struct) throws TException {
        struct.validate();
    ...
    private static class queryChatSessionList_resultTupleScheme extends TupleScheme<queryChatSessionList_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryChatSessionList_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryChatSessionList_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class queryChartRecordList_args implements org.apache.thrift.TBase<queryChartRecordList_args, queryChartRecordList_args._Fields>, java.io.Serializable, Cloneable, Comparable<queryChartRecordList_args>   {
    ...
    private static class queryChartRecordList_argsStandardScheme extends StandardScheme<queryChartRecordList_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryChartRecordList_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryChartRecordList_args struct) throws TException {
        struct.validate();
    ...
    private static class queryChartRecordList_argsTupleScheme extends TupleScheme<queryChartRecordList_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryChartRecordList_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryChartRecordList_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(3);
        if (incoming.get(0)) {
          struct.sessionId = iprot.readI32();
  ...
  public static class queryChartRecordList_result implements org.apache.thrift.TBase<queryChartRecordList_result, queryChartRecordList_result._Fields>, java.io.Serializable, Cloneable, Comparable<queryChartRecordList_result>   {
    ...
    private static class queryChartRecordList_resultStandardScheme extends StandardScheme<queryChartRecordList_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, queryChartRecordList_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, queryChartRecordList_result struct) throws TException {
        struct.validate();
    ...
    private static class queryChartRecordList_resultTupleScheme extends TupleScheme<queryChartRecordList_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, queryChartRecordList_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, queryChartRecordList_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readString();
  ...
  public static class sendMsg_args implements org.apache.thrift.TBase<sendMsg_args, sendMsg_args._Fields>, java.io.Serializable, Cloneable, Comparable<sendMsg_args>   {
    ...
    private static class sendMsg_argsStandardScheme extends StandardScheme<sendMsg_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, sendMsg_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendMsg_args struct) throws TException {
        struct.validate();
    ...
    private static class sendMsg_argsTupleScheme extends TupleScheme<sendMsg_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sendMsg_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetUserId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sendMsg_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
  ...
  public static class sendMsg_result implements org.apache.thrift.TBase<sendMsg_result, sendMsg_result._Fields>, java.io.Serializable, Cloneable, Comparable<sendMsg_result>   {
    ...
    private static class sendMsg_resultStandardScheme extends StandardScheme<sendMsg_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, sendMsg_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendMsg_result struct) throws TException {
        struct.validate();
    ...
    private static class sendMsg_resultTupleScheme extends TupleScheme<sendMsg_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, sendMsg_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, sendMsg_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
